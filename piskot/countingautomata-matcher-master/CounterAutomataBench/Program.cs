...
namespace CounterAutomataBench
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (StreamReader sr = File.OpenText(args[2]))
                {
                    ...
                    {
                        if (pattern.IsMatchCA(s, dca, false))
                        {
                            count++;
                        }
                    }
          ...
          //  File.AppendAllText("./results/results-2020-05-14/time.csv", args[1] + ";" + args[2] + ";" + time + ";"+timeAll + ";\n");

            Console.WriteLine("Time: 0");
            Console.WriteLine("Matching lines: " + count);
         //   Console.Write("States:" + dca.cntStates);
           // Console.Write("Counters:" + dca.cntCount);
          //  Console.Write("Succ:" + (long)Math.Pow(2, dca.cntCount * 4));
            // Console.WriteLine("Max size of CS: " + dca.sizeCS.Max());
          // Console.Read();
        }
    }
}
