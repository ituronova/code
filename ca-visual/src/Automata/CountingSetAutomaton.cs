...
{   
    ...
    public class CsAutomatonOpt<S> : Automaton<CsLabel<S>>
    {
        ...
        public class conf
        {
            ...
            {
                var bs = new BasicCountingSet[this.BasicSet.Length];
        ...
        public override string DescribeState(int state)
        {
            ...
            /* dic[1] = "{" + SpecialCharacters.q(0) + "}";
             dic[2] = "{" + SpecialCharacters.q(0) +", " + SpecialCharacters.q(1) + '\u207D' + '\u2070' + '\u207E' + "}";
             dic[3] = "{" + SpecialCharacters.q(0) + ", " + SpecialCharacters.q(1) + '\u207D' + '\u2070' +  " " + '\u00B9' + "" + '\u207E' + "}";
             dic[4] = "{" + SpecialCharacters.q(0) + ", " + SpecialCharacters.q(1) + '\u207D' + '\u2070' + " " + '\u00B9' + " " + '\u00B2' + '\u207E' + "}";
             dic[5] = "{" + SpecialCharacters.q(0) + ", " + SpecialCharacters.q(1) + '\u207D' + '\u2070' + " " + '\u00B9' + " " + '\u00B2' +"    "+ '\u207E' + ","+ SpecialCharacters.q(2) + "}";
            */
        /*    dic[1] = "{(" +SpecialCharacters.q(0)+ ",c=0)}";
            dic[2] = "{("+SpecialCharacters.q(0)+",c=0),("+SpecialCharacters.q(1)+", c=0)}";
            dic[3] = "{("+SpecialCharacters.q(0)+",c=0),("+SpecialCharacters.q(1)+", c=0), ("+SpecialCharacters.q(1)+", c=1)}";
            dic[4] = "{("+SpecialCharacters.q(0)+",c=0),("+SpecialCharacters.q(1)+", c=0), ..., ("+SpecialCharacters.q(1)+", c=k)}";
            dic[5] = "{(" + SpecialCharacters.q(0) + ", c=0),(" + SpecialCharacters.q(1) + ", c=0), ..., (" + SpecialCharacters.q(1) + ", c=k)}";
           */
            /*dic[1] = "(" + SpecialCharacters.q(0) + ",c=0)";
            dic[2] = "(" + SpecialCharacters.q(1) + ",c=0)";
            dic[3] = "(" + SpecialCharacters.q(1) + ",c=1)";
            dic[4] = "(" + SpecialCharacters.q(1) + ",c=2)";*/
/*
            dic[1] = "({" + SpecialCharacters.q(0) + "},c"+SpecialCharacters.IN+"{0})";
            dic[2] = "({" + SpecialCharacters.q(0) + ","+ SpecialCharacters.q(1) + "},c" + SpecialCharacters.IN + "{0})";
            dic[3] = "({" + SpecialCharacters.q(0) + "," + SpecialCharacters.q(1) + "},c" + SpecialCharacters.IN + "{0,1})";
            dic[4] = "({" + SpecialCharacters.q(0) + "," + SpecialCharacters.q(1) + "},c" + SpecialCharacters.IN + "{10,11})";
            dic[5] = "({" + SpecialCharacters.q(0) + "," + SpecialCharacters.q(1) + "},c" + SpecialCharacters.IN + "{0,11,12})";
            dic[6] = "({" + SpecialCharacters.q(0) + "," + SpecialCharacters.q(1) + "},c" + SpecialCharacters.IN + "{0,1,12,13})";
            dic[7] = "({" + SpecialCharacters.q(0) + "," + SpecialCharacters.q(1) + "},c" + SpecialCharacters.IN + "{87,88,99,100})";

            if (state >7)
               return "";*/
            /* dic[1] = "{" + SpecialCharacters.q(0) + "}";
             dic[2] = "{" + SpecialCharacters.q(0) + "," + SpecialCharacters.q(1) + "}";
             dic[3] = "{" + SpecialCharacters.q(0) + "," + SpecialCharacters.q(1) + "," + SpecialCharacters.q(2)+ "}\nF: \uA4D4";
            */
          //  return dic[state];
           if (state > 3)
               return "";
           ...
           if (!stateDescr.TryGetValue(state, out s))
            ...
            mems.Sort();
           // string[] field = new string[] { "(.{9})*", ".{9}(.{9})*" };
           /// string[] field = new string[] { "{q" + SpecialCharacters.ToSubscript(0) +"}", "{q" + SpecialCharacters.ToSubscript(0) + ",q" + SpecialCharacters.ToSubscript(1) + "}", "{q" + SpecialCharacters.ToSubscript(0) + ",q" + SpecialCharacters.ToSubscript(1) + ",q" + SpecialCharacters.ToSubscript(2) + "}" , "", ""};
          ...
          //  s += field[state-1];
            ...
            if (state_counters != null)
            {
                ...
                foreach (var c in state_counters_list)
                {
                    ...
                    s += "(" + counters[c].LowerBound +                         SpecialCharacters.LEQ + SpecialCharacters.c(c) + SpecialCharacters.LEQ + counters[c].UpperBound + ")";
                  /*  if (finalSet[c])
                    {
            ...
            if (finalSet[state])
            {
                // field = new string[] { "\nF: \uA4D4", "\nF: c" + SpecialCharacters.GEQ + "9" };
               // field = new string[] { "","", "\nF: \uA4D4", "", "", "" };

                //s += field[state - 1];
                var fc = finalCounters[state];
                if (fc.Length == 0)
                {
                    s += "\nF: \uA4D4";
                }
                    ...
                    {
                        s += "c" + SpecialCharacters.GEQ + counters[fc[i]].UpperBound;
                    }
                }
            }
      ...
      /*  public bool[] GetSCC(int s)
       ...
       /* public void FindPath(int u, int d, bool[] isVisited, List<int> nodePath, double[] mapStateToCycles)
        ...
        public void GenerateRandomText(int bound, bool verbose, string folder, string name, bool hybrid)
        {
            ...
            distance = new double[1000000];
            pre = new int[1000000];
            sizeCA = new int[1000000];
            finalState = new bool[100000];
      ...
      /*  public static void Shuffle(List<Tuple<double,int>> ts)
       ...
       /* private int NextReverseStep(int state, List<Tuple<double, int>>[] nextTable, double randomShuffle = 4)
        ...
        {
            // TODO: there is a bug
            BasicCountingSet[] copyCS = new BasicCountingSet[cs.Length];
            for(int i = 0; i < cs.Length; i++)
            {
                ...
                {
                    Console.WriteLine("Error copy it.\n");
                }
            }
        ...
        {            
                    ...
                    foreach (var i in this.updatedCounters[currentConf.Item1][successor.Item3])
                    {
                        ...
                        switch (successor.Item1[i])
                        {
                            case CsUpdate.INCR1:
                                ...
                                break;
                            case CsUpdate.INCR1_EXIT:
                                nextConf.Item2[i].IncrPush1(); // the same as INCR01
                                break;
                            case CsUpdate.INCR:
                            ...
                            case CsUpdate.INCR01:
                                nextConf.Item2[i].IncrPush01();
                                break;
                            case CsUpdate.INCR_EXIT:
                                nextConf.Item2[i].Incr();
                                break;
                            case CsUpdate.INCR0_EXIT:
                                nextConf.Item2[i].IncrPush0(); // the same as INCR0
                                break;
                            case CsUpdate.INCR01_EXIT:
                                nextConf.Item2[i].IncrPush01(); // the same as INCR01
                                break;
            ...
            if (best.Item1 != 0)
            {
                if(newEdge && verbose)
                {
                    ...
                    dotFile += "\n" + currentState + "->";
                    dotFile += bestState + "[label=\" " + m + " | " + output + "\"]";
                    if (hybrid)
                    {
                        dotFile += "\n" + currentState + "[label=\"" + this.ToString(currentConf, distance[currentState], sizeCA[currentState], this.mapStateToCycles[currentConf.Item1]) + "\"]";
                    ...
                    {
                        dotFile += "\n" + mapConf[mapBestConf] + "[fillcolor = lightgrey, style=filled]";
                    }
                    #endregion
                }
                this.currentConf = best;
        ...
        {
           // distance = new double[this.cntStates+1];
          //   pre = new int[this.cntStates+1];
            bool[] shortestPathTreeSet = new bool[this.mapConf.Count()];

            for (int i = 0; i < this.mapConf.Count(); ++i)
            {
            ...
            for (int count = 0; count < this.mapConf.Count(); ++count)
            {
                int u = MinimumDistance(distance, shortestPathTreeSet, this.mapConf.Count());
                shortestPathTreeSet[u] = true;

                for (int v = 0; v < this.mapConf.Count(); ++v)
                    if (!shortestPathTreeSet[v] && confAut[v].Item1 == u && distance[u] + 1 < distance[v])
                    {
                        distance[v] = distance[u] + 1;
                        pre[v] = u;
                    }
            }
            //Print(this.cntStates);
        }
...
#region replace set with incr if possible
        ...
        internal string ToString(bool debugmode)
        {
            ...
            foreach (var psi in cases)
            {
                ...
                if (countercond != SpecialCharacters.TOP.ToString())
                    cond += SpecialCharacters.AND + countercond;
            }
            cond = cond.Replace(".", "\u2022");
            if (isFinalCondition)
            {
    ...
    public class CsUpdateSeq
    {
        ...
        public override string ToString()
        {
            ...
            Dictionary<CsUpdate, string> dict = new Dictionary<CsUpdate, string> { { CsUpdate.INCR0, "INCR(c), RST" }, { CsUpdate.ADD0, "RST"} , { CsUpdate.INCR, "INCR" } };
            bool dicFlag = true;
            for (int i = 0; i < Length; i++)
                if (this[i] != CsUpdate.NOOP)
                {
                    if(dict.Keys.Contains(this[i]) && dicFlag)
                        s += string.Format("{0}({1})", dict[this[i]], "c");                   
                }
            ...
            else
            {
                ...
                for (int i = 0; i < Length; i++)
                {
                    ...
                    switch (this[i])
                    {
                        case CsUpdate.INCR:
                            {
                                s += string.Format("c{0}c+1", SpecialCharacters.ASSIGN);
                                break;
                            }
                        case CsUpdate.INCR0:
                            {
                                s += string.Format("c{0}{{0}}{1}c+1", SpecialCharacters.ASSIGN, SpecialCharacters.UNION);
                                break;
                            }
                        case CsUpdate.INCR1:
                            {
                                s += string.Format("c++", SpecialCharacters.c(i));
                                break;
                            }
                        case CsUpdate.INCR01:
                            {
                                s += string.Format("c++{{0,1}}", SpecialCharacters.c(i));
                                break;
                            }
                        case CsUpdate.ADD0:
                            {
                        ...
                        case CsUpdate.ADD1:
                            {
                                s += string.Format("c:=1", SpecialCharacters.c(i), SpecialCharacters.ASSIGN);
                                break;
                            }
                        case CsUpdate.ADD01:
                            {
    ...
    public class CsConditionSeq
    {
        ...
        public static string DescribeCondition<S>(CsAlgebra<S> algebra, CsCondition cond, int i)
        {
            var dictFlag = true;
            var plus = true;    // c++
         //   var dict = new Dictionary<CsCondition, string> { { CsCondition.EMPTY, "" }, { CsCondition.MIDDLE, string.Format("{0}({3}){1}{2}({3})", SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND,SpecialCharacters.IOTA_LOWERCASE, "c") }, { CsCondition.CANEXIT, string.Format("{0}({3}){1}{2}({3})", SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.IOTA_LOWERCASE, "c") }, { CsCondition.HIGH, string.Format("{0}({4}){1}{2}{3}({4})", SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.NOT, SpecialCharacters.IOTA_LOWERCASE, "c")}, { CsCondition.LOW, string.Format("{0}{1}({4}){2}{3}({4})", SpecialCharacters.NOT, SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND,  SpecialCharacters.IOTA_LOWERCASE, "c") }, { CsCondition.CANLOOP, string.Format("h:{0}({4}){1}{2}{3}({4})", SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.NOT, SpecialCharacters.IOTA_LOWERCASE, "c") } };
            var dict = new Dictionary<CsCondition, string> { { CsCondition.EMPTY, "" }, { CsCondition.MIDDLE, string.Format("Min(c)<100", SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.IOTA_LOWERCASE, "c") }, { CsCondition.CANEXIT, string.Format("Min(c)\\ge 100", SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.IOTA_LOWERCASE, "c") }, { CsCondition.HIGH, string.Format("Min(c){0}100",SpecialCharacters.GEQ ,SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.NOT, SpecialCharacters.IOTA_LOWERCASE, "c") }, { CsCondition.LOW, string.Format("Min(c)<100", SpecialCharacters.NOT, SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.IOTA_LOWERCASE, "c") }, { CsCondition.CANLOOP, string.Format("Min(c)<100", SpecialCharacters.KSI_LOWECASE, SpecialCharacters.AND, SpecialCharacters.NOT, SpecialCharacters.IOTA_LOWERCASE, "c") } };

            if (dictFlag && dict.Keys.Contains(cond))
            {
                return string.Format("{0}", dict[cond]);
            }
            else if(plus)
            {
                switch (cond)
                {
                    ...
                    case CsCondition.LOW:
                        return string.Format("c<{1}", SpecialCharacters.c(i), algebra.GetCounter(i).LowerBound, SpecialCharacters.NEQ, SpecialCharacters.EMPTYSET, SpecialCharacters.AND);

                    case CsCondition.HIGH:
                        return string.Format("c{0}{1}", SpecialCharacters.GEQ, algebra.GetCounter(i).UpperBound);
                    ...
                    case CsCondition.CANLOOP:
                        ...
                        return string.Format("c{0}{1}", SpecialCharacters.LESSTHAN, algebra.GetCounter(i).UpperBound);
                    ...
                    case CsCondition.MIDDLE:
                        return string.Format("c{0}{1}{2}c<{2}", SpecialCharacters.GEQ, algebra.GetCounter(i).LowerBound, SpecialCharacters.AND, SpecialCharacters.LEQ, algebra.GetCounter(i).LowerBound, SpecialCharacters.c(i), algebra.GetCounter(i).UpperBound, SpecialCharacters.NEQ, SpecialCharacters.EMPTYSET, SpecialCharacters.AND);
