...
namespace Microsoft.Automata
{
    internal static class SpecialCharacters
    {
        ...
        public static string IOTA_LOWERCASE = "CanIncr";//'\u03B9';
        ...
        public static string KSI_LOWECASE = "CanExit" ;//'\u03BE';
        ...
        /// Produces subscript index
        /// </summary>
        public static string ToSuperscript(int index)
        {
            var s = index.ToString();
            for (int i = 0; i < 10; i++)
                s = s.Replace((char)((int)'0' + i), (char)(0x2070 + i));
            return s;//.Replace('-', SUBSCRIPTPLUS);
        }
