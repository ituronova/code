        ...
        public override string ToString()
        {
            switch (elems.Item2)
            {
                /// case CounterOp.EXIT:
                 ...
                 case CounterOp.SET0:
                    return "" ; string.Format("", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN);
                ...
                case CounterOp.SET1:
                     return string.Format("c{1}1", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN);
               ...
               //  default:
                 ...
                 case CounterOp.EXIT:
                    ...
                    return string.Format("", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.CIRCLE, LowerBoundCheck, SpecialCharacters.IMPLIES);
                case CounterOp.EXIT_SET1:
                    return string.Format("{2}{3}EXIT{0}SET1({0})", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.CIRCLE, LowerBoundCheck, SpecialCharacters.IMPLIES);
                ...
                case CounterOp.INCR:
                    ...
                    return string.Format("c{0}c+1", SpecialCharacters.ASSIGN);// string.Format("INCR(c)", SpecialCharacters.c(Counter.CounterId), SpecialCharacters.ASSIGN, UpperBoundCheck, SpecialCharacters.IMPLIES);
